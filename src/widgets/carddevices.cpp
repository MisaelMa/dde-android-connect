...
CardDevices::CardDevices(QWidget *parent): RoundedWidget(parent),
...
void CardDevices::setValue(const float &value)
{
...
void CardDevices::setValue(const QString &text)
{
m_percentLabel->setText(text);
}

void CardDevices::setTitle(const QString &text)
{
m_titleLabel->setText(text);
}

void CardDevices::setTips(const QString &text)
{
m_tipsLabel->setText(text);
}

void CardDevices::setColor(const QColor &color)
{
// m_progress->setProgressColor(color);
}

void CardDevices::setIcon(const QString &iconPath, const QSize &size)
{
